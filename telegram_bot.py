...
IMPORTANT :
Les superviseurs sont totalement indépendants
...
“””
Crée une identité stable pour une annonce.

L'objectif est d'éviter d'envoyer plusieurs fois
exactement la même annonce au même utilisateur.
Le moteur de trading n'est jamais consulté.
"""
return "|".join(
    [
...
“””
Envoie une information aux utilisateurs enregistrés.

Cette fonction appartient uniquement au circuit
informationnel.
"""
chat_ids = (
    application
...
“””
Vérifie les ouvertures/fermetures de sessions.

Ce circuit est totalement indépendant du scanner trading.
"""
try:
...
“””
Vérifie les annonces économiques HIGH.

Ce circuit est totalement indépendant du moteur de trading.
"""
...
try:
    ...
    # ----------------------------------------------------
    # Evite que la mémoire des événements grandisse
    # indéfiniment.
    # ----------------------------------------------------
...
“””
Boucle principale des superviseurs informationnels.

Deux circuits indépendants :
    Sessions
    Economic News
Aucun résultat n'est transmis au moteur de trading.
"""
...
#
# Cela évite qu'une session déjà ouverte au moment du
# démarrage soit considérée comme une nouvelle ouverture.
# --------------------------------------------------------
try:
...
# --------------------------------------------------------
# Première vérification des annonces
# --------------------------------------------------------
