...
ENGINE 2 :
    ...
    GBPUSD
    EURUSD
L'orchestration multi-actifs appartient à :
    moteur2.py
    Moteur2Global
Le Telegram ne crée donc plus quatre moteurs indépendants.
"""
...
# ============================================================================
# ORCHESTRATEUR GLOBAL ENGINE 2
# ============================================================================
# IMPORTANT :
# Telegram utilise maintenant UNE seule instance globale.
#
# Moteur2Global :
#     - possède les moteurs multi-actifs
#     - coordonne les analyses
#     - conserve le dernier cycle
#     - utilise Moteur2Ranking pour le classement
#
# Cela évite de recréer quatre Moteur2 indépendants ici.
...
# COMPATIBILITÉ
# ============================================================================
# Ancien code éventuel pouvant rechercher "moteur2".
...
def build_all_engines_status() -> Dict[str, Any]:
    ...
    return {
        ...
        "engines": {},
        "error": "Statut global indisponible.",
    }
...
async def information_supervisor(
    ...
    try:
        ...
        raise
# ============================================================================
# EXTRACTION DES SIGNAUX DU CYCLE GLOBAL
# ============================================================================
...
def _start_background_tasks(
    ...
    if (
        ...
        logger.info(
            "Tâche Information Supervisor créée."
        )
    logger.info(
...
async def post_shutdown(
    ...
    global global_engine_started
    tasks = []
    if global_engine_task is not None:
        tasks.append(
            global_engine_task
        )
