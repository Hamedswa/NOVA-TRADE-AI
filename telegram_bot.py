...
# ============================================================================
# NOUVEAU : EXTRACTION DES SIGNAUX DU RANKING
# ============================================================================
...
def get_ranked_signals() -> list[Any]:
    ...
    Telegram doit publier "signals", jamais les 31 candidats
    du cycle global.
    """
    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                #
                # AVANT :
                #   last_cycle -> 31 signaux
                #
                # MAINTENANT :
                #   last_ranking -> maximum 3 signaux sélectionnés
                #
                # Telegram ne republie donc plus les 31 candidats.
                # ============================================================
                ...
                for signal in signals:
                    ...
                    if signal_key in published_signal_keys:
                        continue
