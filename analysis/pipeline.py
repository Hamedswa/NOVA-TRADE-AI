...
def build_multitimeframe_context(
    ...
    """
    Construit le contexte complet D1/H4/H1/M15.
    IMPORTANT :
    On ne passe plus uniquement D1/H4 à TrendContext.
    """
    return TrendContext(
        d1=d1_direction,
        h4=h4_direction,
