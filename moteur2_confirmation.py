...
class Moteur2Confirmation:
    ...
    def analyser(
        ...
        # M5 doit être confirmé.
        #
        # M1 ne peut jamais remplacer M5.
        #
        # Le score combiné est une information supplémentaire,
        # pas une porte alternative.
        # ----------------------------------------------------
        confirmation_valid = (
            m5_confirmed
            and not major_counter_move
            and combined_score >= self.confirmation_score
        )
        # ----------------------------------------------------
        # STATUS
        # ----------------------------------------------------
