...
Validation critique :
    ...
    SIGNAL
        ↓
    SCORE = QUALITÉ / CONFIANCE UNIQUEMENT

IMPORTANT :

Le score NE BLOQUE PLUS le signal.

Le score sert uniquement à mesurer la qualité
et le niveau de confiance du setup une fois que
les conditions critiques de validation sont réunies.
"""
...
def resolve_trade_direction(
    ...
    2. Sinon :
       ...
       - H4 + M15 alignés -> direction H4/M15
       - H4 seul -> biais H4
       - H1 seul -> H1
       - M15 seul -> M15
       - sinon NEUTRAL
...
def build_signal(
    ...
    **kwargs,
    ...
    Le score est calculé après validation du setup.

    Le score est uniquement une mesure de qualité
    et de confiance.

    Le score ne peut PAS bloquer le signal.
    """
    ...
    # --------------------------------------------------------
    # RR reste une condition critique.
    # --------------------------------------------------------
    ...
    # IMPORTANT :
    #
    # Le score est calculé UNIQUEMENT comme indicateur
    # de qualité/confiance.
    #
    # Il ne constitue PLUS une condition de validation.
    #
    # Exemple :
    #
    #     Setup valide + RR 2.0 + score 45
    #         → SIGNAL ACTIVE
    #
    #     Setup valide + RR 2.0 + score 85
    #         → SIGNAL ACTIVE
    #
    # La différence est uniquement le niveau de qualité.
    # ========================================================
    ...
    # ========================================================
    # 11. SCORE — NON BLOQUANT
    # ========================================================
    #
    # AUCUN seuil de score ici.
    #
    # Le score ne peut plus provoquer :
    #
    #     return None
    #
    # Il sert uniquement à mesurer la qualité
    # et le niveau de confiance du signal.
    #
    # CONFIG.SIGNAL_THRESHOLD n'est donc plus utilisé
    # pour valider ou rejeter ce signal.
    # ========================================================
